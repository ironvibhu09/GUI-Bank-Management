...
public class BankMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("VAIBHAV'S Bank Account Manager");
        ...
        jLabel1.setText("       WELCOME TO VAIBHAV'S BANK RECORD MANAGER !");
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel1, GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jMenuItem1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        String name; 
        long num; 
        name = JOptionPane.showInputDialog(null, "Please Enter Account Holder's Name:", "Create Account", 1);
        num = 1332522123;
    ...
    private void jButton6ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        JOptionPane.showMessageDialog(null,"Created By VAIBHAV RAJPUT", "About", 1);
